...
import temperaments_info as info
...
QUESTIONS = \
    ['1. Часто ли вы испытываете тягу к новым впечатлениям, к тому, чтобы отвлечься, испытывать сильные ощущения?',
     ...
     '40. Верно ли, что вам часто не дают покоя мысли о разных неприятностях и «ужасах», которые могли бы произойти, '
     ...
     '44. Верно ли, что вы так любите поговорить, что не упускаете любого удобного случая '
...
INSINCERITY_TEXT = 'Ваши ответы скорее всего были неискренны. Не волнуйтесь, это не тест! ' \
                   'Отвечайте от души. Здесь не существует правильных ответов и оценок.'

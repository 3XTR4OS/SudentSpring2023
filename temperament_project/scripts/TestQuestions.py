...
import scripts.temperaments_info as info
...
QUESTIONS = \
    ['Часто ли вы испытываете тягу к новым впечатлениям, к тому, чтобы отвлечься, испытывать сильные ощущения?',
     ...
     'Что вы предпочитаете, если хотите узнать что-либо: найти в книге или спросить у друзей?',
     ...
     'Верно ли, что вам часто не дают покоя мысли о разных неприятностях и «ужасах», которые могли бы произойти, '
     ...
     'Верно ли, что вы так любите поговорить, что не упускаете любого удобного случая '
...
EXTROVERSION_INTROVERSION_YES = [1, 3, 8, 10, 13, 17, 22, 25, 27, 39, 44, 46, 49, 53, 56]
EXTROVERSION_INTROVERSION_NO = [5, 15, 20, 29, 32, 34, 37, 41, 51]

# Нейротизм
NEUROTICISM_YES = [2, 4, 7, 9, 11, 14, 16, 19, 21, 23, 26, 28, 31, 33, 35, 38, 40, 43, 45, 47, 50, 52, 55, 57]

# Шкала лжи
LIE_SCALE_YES = [6, 24, 36]
LIE_SCALE_NO = [12, 18, 30, 42, 48, 54]

# Типы темперамента
TEMPERAMENT = {
    'сангвиник': info.TEMPERAMENTS['сангвиник'],
    'холерик': info.TEMPERAMENTS['холерик'],
    'флегматик': info.TEMPERAMENTS['флегматик'],
    'меланхолик': info.TEMPERAMENTS['меланхолик'],
}

INSINCERITY_TEXT = 'Ваши ответы скорее всего были неискренны. Не волнуйтесь, это не тест! ' \
                   'Отвечайте честно! Ведь тут нет правильных ответов.'
